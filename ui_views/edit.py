from ui.py.edit_project import Ui_Dialog
from PyQt6.QtWidgets import QDialog,QApplication
from PyQt6.QtGui import QRegion
from PyQt6.QtCore import Qt,QPoint,QRect,pyqtSignal
import sys
class EditProject(QDialog):
    ...
    def on_submit(self):
        project_name=self.ui.edit_project_name_le.text()
        psp_element=self.ui.edit_psp_element_le.text()
