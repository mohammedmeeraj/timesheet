from ui.py.logged_in_users_employee_dialog import Ui_Dialog
...
from .extract_log_user import ExtractUserLog
class LoggedInUsersEmployee(QDialog):
    def __init__(self,employee_name):
        ...
        self.ui.extract_logs_btn.clicked.connect(self.show_extract_log_dialog)
    ...
    def show_extract_log_dialog(self):
